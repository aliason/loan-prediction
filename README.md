...
## Project Description
This repository contains the code for the final course project of PSTAT 131 (Statistical Machine Learning) at UCSB. Students apply machine learning algorithms on a real-world problem of their choosing and use R Markdown to compile a report of key findings.
